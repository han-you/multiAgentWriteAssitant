...
def research_node(state:ReportState)->dict:
    ...
    try:
        ...
        tokens_list.append({"role":"researcher","completion_tokens":completion_tokens,"prompt_tokens":prompt_tokens})
        print("token_list:"+str(tokens_list))
        print("token_list添加成功")
        cleaned_research=response["content"]
        ...
        print("end search")
    return {"tokens":tokens_list,"search_results": text}
